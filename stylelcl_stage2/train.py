...
def setup_training_loop_kwargs(
    ...
    # args.Noise_mapper_kwags = dnnlib.EasyDict(class_name='training.network_ours.NoiseMapper', w_dim=512)
    # args.Noise_generator_kwargs = dnnlib.EasyDict(class_name='training.network_ours.NoiseGenerator', nz=128)
    args.Adaptor_kwargs = dnnlib.EasyDict(class_name='training.network_ours.Adaptor', w_dim=512)
